# Service Growth Model - security-threat-response-workbench
...
| Field | Decision |
|---|---|
| Service type | Security response workflow |
| Primary reader or buyer | Security teams and MSPs that need structured triage and handoff. |
| Wedge | Tabletop exercise and response-board setup. |

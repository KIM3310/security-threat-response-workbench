...
This document records the approved deployment path for `KIM3310/security-threat-response-workbench` without storing secrets or forcing a production launch.
